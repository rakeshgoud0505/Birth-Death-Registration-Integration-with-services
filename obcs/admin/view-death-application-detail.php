                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Death Application Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list shadow-reset">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>View <span class="table-project-n">Detail of Death</span> Application</h1>
...
if($row->Status=="MVerified")
{
  echo "Your application has been verified";
}

if($row->Status=="MRejected")
{
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="status" class="form-control wd-450" required="true">
                                                                <option value="MVerified">MVerified</option>
                                                                <option value="MRejected">MRejected</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
            ...
            <div class="modal fade" id="acceptModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="post" name="submit">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status" class="form-control wd-450" required="true">
                                <option value="HMVerified" selected="true">MVerified</option>
                                <option value="MRejected">MRejected</option>
                            </select>
                        </td>
                    </tr>
                ...
                <form method="post" name="submit">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status" class="form-control wd-450" required="true">
                                <option value="MVerified">MVerified</option>
                                <option value="MRejected" selected="true">MRejected</option>
                            </select>
                        </td>
                    </tr>
                    <tr>

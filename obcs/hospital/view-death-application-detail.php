                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Death Application Form</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    ?>
                                            <table border="1" class="table table-bordered">
                                                ...
                                                <tr align="center">
                                                    <td colspan="4" style="font-size:20px;color:red">Application Number: <?php echo $row->ApplicationID; ?></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $status = $row->Status;
                                                    if ($row->Status == "HVerified") {
                                                        echo "Your application has been verified";
                                                    }
                                                    if ($row->Status == "HRejected") {

...
<?php 
$sql = "SELECT ID FROM tblapplication WHERE Status IS NULL AND bd_Id = 1 AND H_id = :hospitalID";
$query = $dbh->prepare($sql);
$query->bindParam(':hospitalID', $_SESSION['obcsaid'], PDO::PARAM_INT);
$query->execute();
...
?>  <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <?php 
$sql ="SELECT ID from tblapplication where Status='HVerified' AND bd_Id = 1 AND H_id = :hospitalID ";
$query = $dbh -> prepare($sql);
$query->bindParam(':hospitalID', $_SESSION['obcsaid'], PDO::PARAM_INT);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
                            ...
                            <?php 
$sql ="SELECT ID from tblapplication where Status='HRejected' AND bd_Id = 1 AND H_id = :hospitalID";
$query = $dbh -> prepare($sql);
$query->bindParam(':hospitalID', $_SESSION['obcsaid'], PDO::PARAM_INT);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?><div class="col-lg-4">
                          ...
                          <?php 
 $sql = "SELECT * FROM tblapplication WHERE  bd_Id = 1 AND H_id = :hospitalID";
 $query = $dbh->prepare($sql);
 $query->bindParam(':hospitalID', $_SESSION['obcsaid'], PDO::PARAM_INT);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);

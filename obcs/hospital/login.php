...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT ID, RoleId FROM tblhospital WHERE UserName=:username AND Password=:password";
    ...
    if ($query->rowCount() > 0) {
        ...
        // Check if the user has the required RoleId (assuming 1 is the desired role)
        if ($roleId == 2) {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red">Hospital Login Form</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">

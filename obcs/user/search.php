                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <label class="login2 pull-right pull-right-pro">Registered Mobile
                                                        No</label>
                                                </div>
                                                <div class="col-lg-7">
                                                    <input id="regmob" type="text" name="regmob" required="true"
                                                        class="form-control" placeholder="Registered Mobile Number">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <label class="login2 pull-right pull-right-pro">Certificate
                                                        No</label>
                                                </div>
                                                <div class="col-lg-7">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="login-horizental cancel-wp pull-left">
                                                            ...
                                                            <button class="btn btn-sm btn-primary login-submit-cs"
                                                                type="submit" name="search">Verify</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <?php
                                        if (isset($_POST['search'])) {
                                            ...
                                            $sql = "SELECT tblapplication.*, tbluser.FirstName, tbluser.LastName, tbluser.MobileNumber, tbluser.Address";
                                            if (isset($row->bd_Id) && $row->bd_Id == 2) {
                                                $sql .= ", tbldeathcertificate.*";
                                            }
                                            $sql .= " FROM tblapplication";

                                            if (isset($row->bd_Id) && $row->bd_Id == 2) {
                                                $sql .= " JOIN tbldeathcertificate ON tblapplication.ApplicationID = tbldeathcertificate.ApplicationID";
                                            }

                                            $sql .= " JOIN tbluser ON tblapplication.UserID=tbluser.ID WHERE tbluser.MobileNumber=:regmob AND tblapplication.ApplicationID=:certificateno AND tblapplication.Status='MVerified'";
                                            ...
                                            foreach ($results as $row) {
                                                ...
                                                <table border="1" class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th scope>
                                                            ...
                                                            if (isset($row->bd_Id) && $row->bd_Id == 2) {
                                                                echo "Date of Death";
                                                            } elseif (isset($row->bd_Id) && $row->bd_Id == 1) {
                                                                echo "Date of Birth";
                                                            }
                                                            ?>
                                                        </th>
                                                ...
                                                <a href="download-certificate.php?cid=<?php echo $row->ApplicationID; ?>"

...
if (strlen($_SESSION['obcsuid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query->rowCount() == 0) {
            $sql = "INSERT INTO tblapplication(UserID, bd_Id, ApplicationID, DateofBirth, Gender, FullName, PlaceofBirth, NameOfMother, NameofFather, PermanentAdd, PostalAdd, MobileNumber, Email, MotherAadharNumber, FatherAadharNumber, HospitalName, H_id) 
            ...
            if ($LastInsertId > 0) {
                echo '<script>alert("Birth Certificate applied successfully")</script>';
                ...
                ?>
                    ...
                    <div class="form-group-inner">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" class="form-control" required="true" value="" name="motheraadhar" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" class="form-control" required="true" value="" name="fatheraadhar" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        <div class="form-group-inner">

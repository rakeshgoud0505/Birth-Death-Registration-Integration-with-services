...
<head>
    ...
    <title>Certificate List | Online Birth Certificate System</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Certificates</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <?php } ?>
                                                        <td>
                                                            <a href="certificates.php?viewid=<?php echo htmlentities($row->ID); ?>">
